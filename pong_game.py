# Code from https://codereview.stackexchange.com/questions/194308/simple-python-pong-game
import pygame

print('Play with up and down arrows for right bar and S and W for left bar')
### Colors
WHITE = (255, 255, 255)
BLACK = (0,0,0)
